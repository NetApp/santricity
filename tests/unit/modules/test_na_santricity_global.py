...
class GlobalSettingsTest(ModuleTestCase):
    ...
    def test_init_pass(self):
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 80, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()

        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 80, "default_host_type": "linux dm-mp", "automatic_load_balancing": "disabled",
    ...
    def test_init_fail(self):
        ...
        with self._set_args({"automatic_load_balancing": "enabled", "host_connectivity_reporting": "disabled"}):
            ...
            with self.assertRaisesRegex(AnsibleFailJson, r"Failed to retrieve cache settings."):
                with patch(
                    ...
                    side_effect=[
                        (200, {
                            "productCapabilities": [],
                            "featureParameters": {"cacheBlockSizes": []}
                        }),
                        (200, []),
                        Exception()
                    ]
    ...
    def test_cache_block_size_pass(self):
        ...
        with self._set_args({"cache_flush_threshold": 80, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
        ...
        with self._set_args({"cache_block_size": 16384, "cache_flush_threshold": 80, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 90},
    ...
    def test_change_cache_flush_threshold_required_pass(self):
        ...
        with self._set_args({"cache_block_size": 32768, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
    ...
    def test_change_cache_flush_threshold_required_fail(self):
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 100, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 0, "default_host_type": "linux dm-mp", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
    ...
    def test_change_host_type_required_pass(self):
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "default_host_type": "Windows", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
    ...
    def test_change_host_type_required_fail(self):
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "default_host_type": "NotAHostType", "automatic_load_balancing": "enabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": False, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
    ...
    def test_change_autoload_enabled_required_pass(self):
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "default_host_type": "Windows",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
        ...
        with self._set_args({"cache_block_size": 32768, "cache_flush_threshold": 90, "default_host_type": "Windows", "automatic_load_balancing": "disabled",
                             "host_connectivity_reporting": "enabled", "name": "array1"}):
            instance = NetAppESeriesGlobalSettings()
            instance.get_current_configuration = lambda: {"autoload_capable": True, "autoload_enabled": True, "cache_block_size_options": [16384, 32768],
                                                          "cache_settings": {"cache_block_size": 32768, "cache_flush_threshold": 80},
        ...
        with self._set_args({
            ...
            with self.assertRaisesRegex(AnsibleExitJson, r"'changed': False"):
                with patch(
                    self.REQ_FUNC,
                    side_effect=[
                        (200, {"productCapabilities": [], "featureParameters": {"cacheBlockSizes": []}}),
                        (200, []),
                        (200, [{
                            "defaultHostTypeIndex": 28,
                            "cache": {"cacheBlkSize": 32768, "demandFlushThreshold": 90}
                        }]),
                        (200, {
            ...
            with self.assertRaisesRegex(AnsibleExitJson, r"'changed': True"):
                with patch(
                    ...
                    side_effect=[
                        ...
                        (200, {
                            "autoLoadBalancingEnabled": True,
                            "hostConnectivityReportingEnabled": True, "name": "array1"
                        })
                    ] * 2
                ):
                    instance.update()
