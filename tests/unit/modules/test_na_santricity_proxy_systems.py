...
class StoragePoolTest(ModuleTestCase):
    ...
    def test_valid_options_pass(self):
        ...
        with self._set_args(options_list[0]):
            systems = NetAppESeriesProxySystems()
    ...
    def test_invalid_options_fail(self):
        ...
        with self._set_args({"password": "password", "systems": [[]]}):
    ...
    def test_discover_array_pass(self):
        ...
        with self._set_args({
            ...
            response = {
                ...
                "storageSystems": [
                    ...
                    {
                        "serialNumber": "2",
                        "ipAddresses": ["192.168.1.15", "192.168.1.16"],
                        "supportedManagementPorts": ["symbol"]
                    },
                    {
                        "serialNumber": "3",
                        "ipAddresses": ["192.168.1.25", "192.168.1.26"],
                        "supportedManagementPorts": ["https", "symbol"]
                    },
                    {
                        "serialNumber": "4",
                        "ipAddresses": ["192.168.1.35", "192.168.1.36"],
                        "supportedManagementPorts": ["symbol"]
                    }
                ]
            }
                    ...
                    self.assertEqual(systems.systems, [
                        {
                            ...
                            "meta_tags": [],
                            "controller_addresses": ["192.168.1.5", "192.168.1.6"],
                        ...
                        },
                        {
                            ...
                            "stored_password_valid": None,
                            "meta_tags": [],
                            "controller_addresses": ["192.168.1.35", "192.168.1.36"],
                        ...
                        },
                        {
                            ...
                            "stored_password_valid": None,
                            "meta_tags": [],
                            "controller_addresses": ["192.168.1.15", "192.168.1.16"],
                            "embedded_available": False,
                            "accept_certificate": False,
                            "current_info": {},
                            "changes": {},
        ...
        with self._set_args({
            "password": "password", "subnet_mask": "192.168.1.0/24", "add_discovered_systems": True
        }):
            response = {
                "discoverProcessRunning": False,
                "storageSystems": [
                ...
                with mock.patch(self.REQUEST_FUNC, side_effect=[(200, {"requestId": "1"}), (200, {"discoverProcessRunning": True}), (200, response)]):
                    ...
                    self.assertEqual(systems.systems, [
                        ...
                        },
                        {
                            ...
                            "stored_password_valid": None,
                            "meta_tags": [],
                            "controller_addresses": ["192.168.1.25", "192.168.1.26"],
                            "embedded_available": True,
                            "accept_certificate": True,
                            "current_info": {},
                            "changes": {},
    ...
    def test_discover_array_fail(self):
        ...
        with self._set_args({"password": "password", "subnet_mask": "192.168.1.0/24", "add_discovered_systems": True}):
            systems = NetAppESeriesProxySystems()
    ...
    def test_update_storage_systems_info_pass(self):
        ...
        with self._set_args({"password": "password", "subnet_mask": "192.168.1.0/24",
    ...
    def test_apply_pass(self):
        ...
        with self._set_args({"password": "password", "subnet_mask": "192.168.1.0/24", "add_discovered_systems": False,
                             "systems": [{"ssid": "1", "serial": "1"}, {"addresses": ["192.168.1.36"]}, {"serial": "2"}, {"serial": "5"}]}):
            systems = NetAppESeriesProxySystems()
