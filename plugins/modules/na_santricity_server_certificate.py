...
options:
  ...
  certificates:
    description:
      ...
      - Root/intermediate authority or the public server certificate files can be in either PEM format or DER encryption.
      - Private key file must be PEM format and non-encrypted.
    type: list
    required: false
notes:
